 ...
 *
 * Configuration settings for the Samsung iTop4412(EXYNOS4410) board.
 *
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"dtb_name=exynos4412-iTop4412.dtb\0" \
...
#define CONFIG_ENV_OFFSET           (UBOOT_START_OFFSET + COPY_UBOOT_SIZE)
